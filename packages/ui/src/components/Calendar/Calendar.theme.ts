...
export const CALENDAR_STYLES = {
  ...
  rangeHighlightStart:
    "absolute top-1/2 -translate-y-1/2 right-0 w-1/2 h-[85%] bg-emerald-100 z-0 pointer-events-none",
  rangeHighlightEnd:
    "absolute top-1/2 -translate-y-1/2 left-0 w-1/2 h-[85%] bg-emerald-100 z-0 pointer-events-none",
  rangeHighlightMid:
    "absolute top-1/2 -translate-y-1/2 left-0 right-0 w-full h-[85%] bg-emerald-100 z-0 pointer-events-none",
  hoverRing:
    "absolute h-[85%] aspect-square rounded-full border-2 border-transparent group-hover:border-neutral-900 transition-colors pointer-events-none",
  selectedStart:
    "absolute h-[85%] aspect-square bg-emerald-700 rounded-full z-10 shadow-md transition-transform active:scale-95 group-hover:scale-105",
  selectedEnd:
    "absolute h-[85%] aspect-square bg-emerald-700 rounded-full z-10 shadow-md transition-transform active:scale-95 ring-2 ring-emerald-700 ring-offset-2 group-hover:scale-105",
