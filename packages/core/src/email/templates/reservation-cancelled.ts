...
export function reservationCancelledHtml(
  guestName: string,
          ...
          <td>
            ...
            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="text-align:center;padding-top:24px;padding-bottom:24px">
              <tbody>
                <tr>
                  <td>
                    <div style="display:inline-block;background-color:rgb(254,226,226);color:rgb(153,27,27);padding-left:16px;padding-right:16px;padding-top:8px;padding-bottom:8px;border-radius:20px;border-width:1px;border-style:solid;border-color:rgb(252,165,165)">
                  ...
                  <td>
                    ...
                    <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background-color:rgb(249,250,251);border-radius:8px;padding:24px;margin-bottom:24px">
                      <tbody>
                        <tr>
                          <td>
                            <p style="font-size:18px;font-weight:700;color:rgb(30,41,59);margin-bottom:16px;line-height:24px;margin-top:16px">${s.DETAILS_TITLE}</p>
                            ...
                            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                              <tbody style="width:100%">
                                <tr style="width:100%">
                                  <td style="width:130px;vertical-align:top"><p style="font-size:14px;font-weight:600;color:rgb(75,85,99);margin:0px;line-height:24px">${s.LABEL_REASON}</p></td>
                                  <td><p style="font-size:14px;color:rgb(153,27,27);margin:0px;line-height:24px">${cancellationReason}</p></td>
                                </tr>
                              </tbody>
                            </table>
                          </td>
                    ...
                    <p style="font-size:14px;color:rgb(75,85,99);margin-bottom:24px;line-height:20px;margin-top:16px">${s.FOOTER_NOTE}</p>
                  </td>
                </tr>
              </tbody>
            </table>
