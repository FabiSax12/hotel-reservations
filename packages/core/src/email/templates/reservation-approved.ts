...
export function reservationApprovedHtml(
  guestName: string,
          ...
          <td>
            ...
            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="text-align:center;padding-top:24px;padding-bottom:24px">
              <tbody>
                <tr>
                  <td>
                    <div style="display:inline-block;background-color:rgb(220,252,231);color:rgb(22,101,52);padding-left:16px;padding-right:16px;padding-top:8px;padding-bottom:8px;border-radius:20px;border-width:1px;border-style:solid;border-color:rgb(187,247,208)">
                            ...
                            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                              <tbody style="width:100%">
                                <tr style="width:100%">
                                  ...
                                  <td><p style="font-size:14px;font-weight:700;color:rgb(22,101,52);margin:0px;line-height:24px">$${totalUSD} USD</p></td>
                                </tr>
                              </tbody>
                            </table>
                          </td>
