...
export function reservationCompletedHtml(
  guestName: string,
          ...
          <td>
            ...
            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="text-align:center;padding-top:24px;padding-bottom:24px">
              <tbody>
                <tr>
                  <td>
                    <div style="display:inline-block;background-color:rgb(219,234,254);color:rgb(30,64,175);padding-left:16px;padding-right:16px;padding-top:8px;padding-bottom:8px;border-radius:20px;border-width:1px;border-style:solid;border-color:rgb(147,197,253)">
                        ...
                        <tr>
                          <td>
                            ...
                            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                              <tbody style="width:100%">
                                <tr style="width:100%">
                                  <td style="width:130px"><p style="font-size:14px;font-weight:600;color:rgb(75,85,99);margin:0px;line-height:24px">${t.LABEL_TOTAL}</p></td>
                                  <td><p style="font-size:14px;font-weight:700;color:rgb(30,64,175);margin:0px;line-height:24px">$${totalUSD} USD</p></td>
                                </tr>
                              </tbody>
                            </table>
                          </td>
