  ...
  return (
    <main className={AS.main}>
      ...
      <div className={S.contentWrapper}>
        <h2 className={S.title}>{t.AUTH.ERRORS.ERROR_BOUNDARY_TITLE}</h2>

        <p className={S.description}>{error.message || t.AUTH.ERRORS.UNKNOWN_ERROR}</p>

        <Button onPress={() => reset()} className={S.button}>
