...
export const ROOM_CARD_STYLES = {
  ...
  adminTipQuoteText:
    "text-sm italic text-stone-300 leading-relaxed font-medium",
  ...
  dialogContent:
    "mt-4 pt-6 pb-2 border-t border-forest-800 bg-forest-900/50 rounded-2xl px-5 py-5",
  ...
  detailCloseBtn:
    "absolute top-5 right-5 z-20 h-10 w-10 rounded-full border border-forest-700 bg-forest-950/95 text-stone-400 shadow-sm transition-colors hover:bg-forest-800 hover:text-gold-500",
