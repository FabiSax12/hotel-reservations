...
export const DESTINATION_POPOVER_STYLES = {
  ...
  previewImageGrad:
    "absolute inset-0 bg-gradient-to-t from-emerald-950/80 via-emerald-900/20 to-transparent",
  ...
  previewHighlightDot:
    "w-6 h-6 rounded-full bg-emerald-50 flex items-center justify-center flex-shrink-0 shadow-sm border border-emerald-100",
