...
export const AUTH_STYLES = {
  ...
  bgImage: "absolute inset-0 bg-cover bg-center scale-105", // slightly scaled for parallax-like feel
  bgOverlay: "absolute inset-0 bg-white/40 backdrop-blur-md", // soft wash for legibility
