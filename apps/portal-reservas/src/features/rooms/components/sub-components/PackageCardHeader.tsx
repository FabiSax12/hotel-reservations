    ...
    <div className={S.imageWrapper}>
      {isHomogeneous || roomCount === 1 ? (
        <div className={S.imageSingle}>
          <div className={S.image} style={{ backgroundImage: `url(${rooms[0].image})` }} />
        </div>
      ) : roomCount === 2 ? (
        ...
        <div className={S.imageGrid3}>
          ...
          <div className={S.imageCell}>
            <div className={S.image} style={{ backgroundImage: `url(${rooms[1].image})` }} />
          </div>
          <div className="col-span-2 relative overflow-hidden">
            <div className={S.image} style={{ backgroundImage: `url(${rooms[2].image})` }} />
          </div>
        </div>
      ) : (
