...
import { Waves, UtensilsCrossed, Compass, Flower2, Camera, Helicopter, Bird, BellRing } from "lucide-react";
import type { ServicesTexts } from "@/features/landing/services/i18n/servicesTexts.type";

export type ServiceId = keyof Pick<
  ServicesTexts,
  "THERMAL" | "RESTAURANT" | "EXPEDITIONS" | "YOGA" | "PHOTOGRAPHY" | "TRANSFERS" | "SANCTUARY" | "BUTLER"
>;
