  ...
  return (
    <div className={GALLERY.MOBILE_WRAPPER}>
      {GALLERY_CONFIG.map((item, i) => {
        ...
        return (
          <div key={item.id} className={GALLERY.MOBILE_CARD} style={{ height: "280px" }}>
            <div className={GALLERY.MOBILE_CARD_INNER}>
              ...
              <div
                ...
                style={{
                  background: "linear-gradient(to top, oklch(8% 0.03 143 / 0.88), transparent)",
                }}
              />
              ...
              {i === current && <div className={GALLERY.MOBILE_CARD_DOT} />}
            </div>
          </div>
        );
      })}
