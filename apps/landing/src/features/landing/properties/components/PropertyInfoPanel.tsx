...
export function PropertyInfoPanel({ texts }: PropertyInfoPanelProps) {
  return (
    <div className={PROPERTIES.INFO}>
      <motion.p className={PROPERTIES.INFO_LOCATION}
      ...
      <motion.p className={PROPERTIES.INFO_TAGLINE}
        initial={{ opacity: 0 }} animate={{ opacity: 1 }}
        transition={{ duration: 0.8, delay: 0.35, ease: EXPO_OUT }}>
        {texts.TAGLINE}
      </motion.p>

      <motion.div className={PROPERTIES.INFO_DIVIDER}
        initial={{ scaleX: 0 }} animate={{ scaleX: 1 }}
        transition={{ duration: 0.7, delay: 0.4, ease: EXPO_OUT }}
        style={{ originX: 0 }} />

      <motion.p className={PROPERTIES.INFO_DESC}
        initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8, delay: 0.45, ease: EXPO_OUT }}>
        {texts.DESCRIPTION}
      </motion.p>

      <motion.ul className={PROPERTIES.INFO_FEATURES}
        initial={{ opacity: 0 }} animate={{ opacity: 1 }}
      ...
      <motion.a href="#" className={PROPERTIES.INFO_CTA}
        initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
