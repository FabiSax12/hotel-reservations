...
export const AUTH_TEXTS: Record<SupportedLocale, AuthTexts> = {
  es: {
    ...
    ACTIVATE: {
      ...
      SUBTITLE: "Establecé una contraseña para activar tu cuenta de administrador.",
      PASSWORD_LABEL: "Contraseña",
      PASSWORD_PLACEHOLDER: "Ingresá tu contraseña",
      CONFIRM_PASSWORD_LABEL: "Confirmar contraseña",
      CONFIRM_PASSWORD_PLACEHOLDER: "Repetí tu contraseña",
      SUBMIT_BUTTON: "Activar cuenta",
      SUBMITTING: "Activando...",
      SUCCESS_TITLE: "¡Cuenta activada!",
      SUCCESS_MESSAGE: "Tu cuenta fue activada correctamente. Ya podés iniciar sesión.",
      SUCCESS_LOGIN_LINK: "Ir al inicio de sesión",
      LOADING: "Verificando enlace de activación...",
      ERRORS: {
        INVALID_TOKEN: "El enlace de activación es inválido.",
        EXPIRED_TOKEN: "El enlace de activación expiró.",
        PASSWORDS_DONT_MATCH: "Las contraseñas no coinciden.",
        UNKNOWN_ERROR: "Algo salió mal. Intentá de nuevo.",
        CONTACT_ADMIN: "Contactá al administrador principal para solicitar un nuevo enlace.",
      },
    },
    VALIDATION: {
      INVALID_EMAIL: "Ingresá un email válido",
  ...
  en: {
    ...
    ACTIVATE: {
      ...
      SUBTITLE: "Set a password to activate your administrator account.",
      PASSWORD_LABEL: "Password",
      PASSWORD_PLACEHOLDER: "Enter your password",
      ...
      SUCCESS_MESSAGE: "Your account was successfully activated. You can now sign in.",
      SUCCESS_LOGIN_LINK: "Go to sign in",
      LOADING: "Verifying activation link...",
      ERRORS: {
        INVALID_TOKEN: "The activation link is invalid.",
        EXPIRED_TOKEN: "The activation link has expired.",
        PASSWORDS_DONT_MATCH: "Passwords do not match.",
        UNKNOWN_ERROR: "Something went wrong. Please try again.",
        CONTACT_ADMIN: "Contact the main administrator to request a new link.",
      },
    },
    VALIDATION: {
      INVALID_EMAIL: "Please enter a valid email address",
