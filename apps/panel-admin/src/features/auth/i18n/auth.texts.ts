...
export const AUTH_TEXTS: Record<SupportedLocale, AuthTexts> = {
  es: {
    ...
    ACTIVATE: {
      ...
      HIDE_CONFIRM_PASSWORD: "Ocultar contraseña de confirmación",
      SHOW_CONFIRM_PASSWORD: "Mostrar contraseña de confirmación",
  ...
  en: {
    ...
    ACTIVATE: {
      ...
      HIDE_CONFIRM_PASSWORD: "Hide confirmation password",
      SHOW_CONFIRM_PASSWORD: "Show confirmation password",
