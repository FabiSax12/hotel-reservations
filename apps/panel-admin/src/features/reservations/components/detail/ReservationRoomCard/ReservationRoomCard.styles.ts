export const RESERVATION_ROOM_CARD_STYLES = {
  ...
  arrivesToday:
    "text-[10px] font-bold uppercase tracking-widest text-emerald-600 bg-emerald-50 border border-emerald-200 rounded-full px-2.5 py-0.5",
  ...
  nightsBadge:
    "bg-[#f6f5ef] border border-[#e9e8e1] rounded-full px-2 py-0.5 text-[10px] font-medium text-gray-600 whitespace-nowrap",
  ...
  guestChip:
    "bg-[#f6f5ef] border border-[#e9e8e1] rounded-full px-2.5 py-0.5 text-xs text-gray-600 font-medium",
} as const;
