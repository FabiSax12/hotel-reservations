export const AMENITY_CARD_STYLES = {
  ...
  cardTriggerBtn: (
    isSelected: boolean,
    position: typeof AMENITY_CARD_CONSTANTS.POS_LEFT | typeof AMENITY_CARD_CONSTANTS.POS_RIGHT,
  ) => `
  ...
  dropdownItemContent: (
    type: typeof AMENITY_CARD_CONSTANTS.ACTION_EDIT | typeof AMENITY_CARD_CONSTANTS.ACTION_DELETE,
  ) => `
