...
export const ROOMS_TEXTS: Record<SupportedLocale, RoomsTexts> = {
  es: {
    ...
    AMENITIES: {
      ...
      ITEMS: {
        [PREDEFINED_AMENITY_IDS.WIFI]: { name: "WiFi", description: "Acceso a internet de alta velocidad" },
        [PREDEFINED_AMENITY_IDS.AIR_CONDITIONING]: { name: "Aire Acondicionado", description: "Control de clima para su comodidad" },
        [PREDEFINED_AMENITY_IDS.TV]: { name: "TV", description: "Televisión de pantalla plana con canales por cable" },
        [PREDEFINED_AMENITY_IDS.MINI_BAR]: { name: "Mini Bar", description: "Refrescos y bocadillos disponibles" },
        [PREDEFINED_AMENITY_IDS.SAFE_BOX]: { name: "Caja Fuerte", description: "Almacenamiento seguro para sus objetos de valor" },
        [PREDEFINED_AMENITY_IDS.DESK]: { name: "Escritorio", description: "Espacio de trabajo dedicado" },
        [PREDEFINED_AMENITY_IDS.HAIR_DRYER]: { name: "Secador de Pelo", description: "Disponible en el baño" },
        [PREDEFINED_AMENITY_IDS.BALCONY]: { name: "Balcón", description: "Espacio privado al aire libre" },
        [PREDEFINED_AMENITY_IDS.POOL]: { name: "Piscina", description: "Acceso a la piscina del hotel" },
  ...
  en: {
    ...
    AMENITIES: {
      ...
      ITEMS: {
        ...
        [PREDEFINED_AMENITY_IDS.AIR_CONDITIONING]: { name: "Air Conditioning", description: "Climate control for your comfort" },
        [PREDEFINED_AMENITY_IDS.TV]: { name: "TV", description: "Flat-screen TV with cable channels" },
        [PREDEFINED_AMENITY_IDS.MINI_BAR]: { name: "Mini Bar", description: "Refreshments and snacks available" },
        [PREDEFINED_AMENITY_IDS.SAFE_BOX]: { name: "Safe Box", description: "Secure storage for your valuables" },
        [PREDEFINED_AMENITY_IDS.DESK]: { name: "Desk", description: "Dedicated workspace" },
        [PREDEFINED_AMENITY_IDS.HAIR_DRYER]: { name: "Hair Dryer", description: "Available in the bathroom" },
        [PREDEFINED_AMENITY_IDS.BALCONY]: { name: "Balcony", description: "Private outdoor space" },
        [PREDEFINED_AMENITY_IDS.POOL]: { name: "Swimming Pool", description: "Access to the hotel pool" },
