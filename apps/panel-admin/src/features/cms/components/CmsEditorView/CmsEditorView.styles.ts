export const CMS_EDITOR_VIEW_STYLES = {
  ...
  sectionTabs: "flex border-b border-slate-100",
  sectionTab:
    "flex-1 py-3 px-4 text-sm font-semibold text-slate-500 transition-all hover:text-slate-800 hover:bg-slate-50",
  sectionTabActive: "text-emerald-700 border-b-2 border-emerald-600 bg-white hover:bg-white",
  body: "p-6",
} as const;
